    ...
    <main className="watchlist-page">
      <section className="panel">
        ...
        <p className="lookup-feedback compact">
          이 탭은 기존 MSDS와 신규 MSDS를 같은 제품으로 묶은 뒤, 성분 변화와 공식 API 변경 후보를 확인하기 위한 준비 화면입니다. 현재 MVP에서는 등록값 작성, 현장관리 연결, 물질정보 확인을 우선 사용합니다.
        </p>
        <div className="explain-flow">
          <article>
            <strong>1. 현장관리 연결</strong>
            <span>사용자가 현장관리에서 같은 자재의 기존 MSDS와 신규 MSDS를 같은 제품으로 묶습니다.</span>
          </article>
          <article>
